$(document).ready(function(){
  ...
  kmwDataReset = function() {
    for (var i = 0; i < $.kmw.length; i++) {
      $["kmw"][i]["v"] = ''
    };
  }

  kmwDataUpdate = function() {
    // get input fields
    $('#kmw-fields input,#kmw-fields select').each(function(){
      // get key from id
      element_name = $(this).attr("id").substr(8)
